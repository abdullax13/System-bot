    ...
    try {
      ...
      for (let y = 0; y < H; y++) {
        for (let x = 0; x < W; x++) {
          ...
          if (satLike < 18 && r > 60 && r < 220 && g > 60 && g < 220 && b > 60 && b < 220) {
            data[idx + 3] = 0;
          }
        }
      }
      ...
      // overlay فوق الأفاتار عشان النار/الإطار يطلعون فوق
